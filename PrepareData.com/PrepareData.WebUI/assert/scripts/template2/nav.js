...
$("#Information1_id").click(function(){
						   $(this).children('a').addClass("now1");
						   $(this).siblings().children('a').removeClass("now1");
						   $("#Information1").css("display","block");
						   $("#News1").css("display","none");
						    $("#Science1").css("display","none");
									});

$("#News1_id").click(function(){
						   $(this).children('a').addClass("now1");
						   $(this).siblings().children('a').removeClass("now1");
	...
	$("#Science1_id").click(function(){
						   $(this).children('a').addClass("now1");
						   $(this).siblings().children('a').removeClass("now1");
						   $("#Information1").css("display","none");
						   $("#News1").css("display","none");
						    $("#Science1").css("display","block");
									});	
